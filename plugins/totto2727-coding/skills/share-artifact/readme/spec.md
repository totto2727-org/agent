...
| Repository structure, architecture, package management, path aliases, conventions, development tools, language rules, and AI constraints | No                                     | Yes                                    | These govern work on the repository.                                 |
