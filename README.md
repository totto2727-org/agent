...
For the current project, initialize project-local state and add the marketplace:
...
For all projects using the current home directory, initialize global state and add the marketplace globally:
